 ...
 */
function updateDragonScene(sceneName) {
    if (gameState.currentAdventure) {
        gameState.currentAdventure.currentScene = sceneName;
        gameState.currentAdventure.state = dragonState;
        saveGameProgress();
    }
}

/**
 * Resume Dragon Cave from saved checkpoint
 */
async function resumeDragonCave(sceneName) {
    addStoryText(`
═══════════════════════════════════════════════════════════════════
...
═══════════════════════════════════════════════════════════════════
    ...
    const sceneMap = {
        'prologue': prologue_dragon,
        'meet_thorgar': meet_thorgar,
        'kobold_scouts': kobold_scouts_dragon,
        'ancient_warning': ancient_warning_dragon,
        'trapped_merchant': trapped_merchant_dragon,
        'lava_chasm': lava_chasm_dragon,
        'dragon_guardians': dragon_guardians,
        'hoard_temptation': hoard_temptation,
        'dragon_awakens': dragon_awakens,
        'epic_dragon_battle': epic_dragon_battle
    };
...
async function meet_thorgar() {
    updateDragonScene('meet_thorgar');
...
async function kobold_scouts_dragon() {
    updateDragonScene('kobold_scouts');
...
async function trapped_merchant_dragon() {
    updateDragonScene('trapped_merchant');
...
async function dragon_awakens() {
    updateDragonScene('dragon_awakens');
...
async function epic_dragon_battle() {
    updateDragonScene('epic_dragon_battle');
